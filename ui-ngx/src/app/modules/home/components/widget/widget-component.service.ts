    ...
    if (this.init$) {
      ...
      widgetModulesTasks.push(from(import('flot/lib/jquery.flot.js')).pipe(
        mergeMap(() => {
          ...
          flotJsPluginsTasks.push(from(import('flot/jquery.flot.crosshair.js')));
          flotJsPluginsTasks.push(from(import('flot/jquery.flot.stack.js')));
          flotJsPluginsTasks.push(from(import('flot/jquery.flot.symbol.js')));
